...
class WebSocketHandler(websocket.WebSocketHandler):
    ...
    def send_data(self):
        ...
        # TODO decide on the message polling frequency: you could make this
        # less frequent and cache some data in the browser but run everything
        # a minute in arrears create new ioloop instance to intermittently
        # publish data
